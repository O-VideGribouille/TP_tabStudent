...
<body>
		...
		<nav id="Nav" name="Nav" class="navigation">
			 	...
			 	<ul id="Ul_nav" name="Ul_nav">
 					...
 					<!-- -->
  					...
  					<li id="li2" name="li2" class="list_nav btn-2"> 
  						...
  						<a href="#" id="lien2" name="lien2" class="btn"> * </a> 
  					...
  					<li id="li3" name="li3" class="list_nav btn-2">
  						...
  						<a href="./HTML/userpage.php" id="lien3" name="lien3" class="btn"> Exercice </a> 
			...
			<!--	<ul id="Ul_nav" name="Ul_nav">
			 		...
			 		<!-- -->
  					...
  					<li id="li4" name="li4" class="list_nav btn-2">

  						<a href="#" id="lien4" name="lien4" class="btn"> Connexion </a>  
	...
	<!-- -->
		...
		<div id="DivPrin" name="DivPrin" class="DivArticle">
			...
			<h1 id="Title1" name="Title1" class="Title_A">TP PHP & BDD :</h1>
			<!-- -->
			<!-- -->
			...
			* Tableaux avec CSS // Tableaux structuré // Table ou Div
			* Données triées
